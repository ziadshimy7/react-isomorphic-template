...
export const Transaction: FC<RecentTransactionsProps> = ({ photo, amount, date, rate, name }) => (
  <div className={styles.transaction}>
    <img loading="lazy" className={styles.transaction__profile_photo} src={photo} alt="Profile" />
